...
(function () {
  ...
  function initCanvas() {
    ...
    function drawAura(ctx) {
      if (!_heroRect) _heroRect = canvas.getBoundingClientRect();
  ...
  function loop(t) {
    ...
    // Inner: responsive
    auraInner.x = lerp(auraInner.x, mouse.x, 0.10);
    auraInner.y = lerp(auraInner.y, mouse.y, 0.10);
